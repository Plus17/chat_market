defmodule ChatMarketWeb.AvailableBlockController do
  ...
  def index(conn, params) do
    ...
    render(conn, "index.html",
      ...
      current_user_available_blocks: current_user_available_blocks,
      block_user_requester_id: params["block_user_requester_id"]
    )
  end
  ...
  def create(conn, params) do
    redirect(conn,
      to:
        Routes.available_block_path(conn, :index,
          block_user_requester_id: params["block_user_requester_id"]
        )
    )
  end
