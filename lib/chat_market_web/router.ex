defmodule ChatMarketWeb.Router do
  use ChatMarketWeb, :router

  import ChatMarketWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, {ChatMarketWeb.LayoutView, :root}
  ...
  if Mix.env() in [:dev, :test] do
    ...
    scope "/" do
      pipe_through :browser
      live_dashboard "/dashboard", metrics: ChatMarketWeb.Telemetry
    end
  end
  ...
  scope "/", ChatMarketWeb do
    ...
    post "/switch_request/:id", SwitchRequestController, :update
